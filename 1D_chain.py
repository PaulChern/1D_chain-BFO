...
Px = np.array([ x for x, _ in zip(sp.numbered_symbols('Px'), range(0,DW_size))])
Py = np.array([ x for x, _ in zip(sp.numbered_symbols('Py'), range(0,DW_size))])
Pz = np.array([ x for x, _ in zip(sp.numbered_symbols('Pz'), range(0,DW_size))])
...
epsilon_11 = np.array([ x for x, _ in zip(sp.numbered_symbols('epsilon_11'), range(0,DW_size))])
epsilon_22 = np.array([ x for x, _ in zip(sp.numbered_symbols('epsilon_22'), range(0,DW_size))])
epsilon_33 = np.array([ x for x, _ in zip(sp.numbered_symbols('epsilon_33'), range(0,DW_size))])
epsilon_12 = np.array([ x for x, _ in zip(sp.numbered_symbols('epsilon_12'), range(0,DW_size))])
epsilon_23 = np.array([ x for x, _ in zip(sp.numbered_symbols('epsilon_23'), range(0,DW_size))])
epsilon_31 = np.array([ x for x, _ in zip(sp.numbered_symbols('epsilon_31'), range(0,DW_size))])
epsilon = np.array([epsilon_11, epsilon_22, epsilon_33, epsilon_12, epsilon_23, epsilon_31])

variables_initial = [Px_initial,
                     Py_initial,
                     Pz_initial,
                     np.random.rand(1,DW_size)[0]/10.0,
                     np.random.rand(1,DW_size)[0]/10.0,
                     np.random.rand(1,DW_size)[0]/10.0,
                     np.random.rand(1,DW_size)[0]/10.0,
                     np.random.rand(1,DW_size)[0]/10.0,
